...
function ModalContent({
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-4 text-gray-900 shadow data-[state=closed]:animate-dialogContentHide data-[state=open]:animate-dialogContentShow">
        <div
