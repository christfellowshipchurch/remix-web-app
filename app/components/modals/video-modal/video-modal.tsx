...
export function VideoModal({
  ...
  return (
    <Modal open={openModal} onOpenChange={setOpenModal}>
      ...
      <Modal.Content>
        <div className="text-center text-text_primary p-7 md:p-9 w-[90vw] max-w-sm md:max-w-screen lg:max-w-3xl overflow-y-scroll aspect-[9/16] md:aspect-video max-h-[75vh] md:max-h-[90vh]">
