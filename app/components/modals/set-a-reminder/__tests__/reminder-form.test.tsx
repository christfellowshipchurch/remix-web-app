...
const mockLoadFetcher = { state: "idle" as const, data: undefined as unknown, load: vi.fn(), submit: vi.fn() };
const mockSubmitFetcher = { state: "idle" as const, data: undefined as unknown, load: vi.fn(), submit: vi.fn() };
...
describe("ReminderForm", () => {
  ...
  it("calls setServiceTime when a service time is selected", () => {
    ...
    const select = screen.getByText("Select a Service Time").closest("select") as HTMLSelectElement;
