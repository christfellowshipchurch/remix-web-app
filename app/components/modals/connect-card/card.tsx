...
import ConnectCardCheckboxes from "./checkboxes";
...
const ConnectCard: React.FC<ConnectCardProps> = ({ onSubmit }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // TODO: SETUP SUBMIT CONNECT CARD LOGIC

    // Will display the confirmation modal if successful
    try {
      await onSubmit("Connect");
    } catch (err) {
