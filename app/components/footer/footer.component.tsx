...
export const Footer = () => {
  ...
  return (
    <footer
      className='flex flex-col items-center w-full bg-navy px-4 lg:px-18 relative z-30'
      // Google Translate (app/lib/google-translate.ts) should leave footer
      // links/labels untouched, same as the navbar.
      translate='no'
    >
