...
const TitleSection = ({ isSpanish }: { isSpanish?: boolean }) => {
  const copy = isSpanish
    ? {
        ...
        subtitle: `¡Le dijiste que sí a Jesús y estamos muy emocionados por ti! Ahora, ¿qué sigue? Dentro de este devocional, descubrirás más sobre lo que significa seguir a Jesús. Cada día incluirá Escrituras para meditar e ideas para considerar al comenzar tu caminar con Dios. Juntos, analizaremos cómo es tener una relación con Jesús y cómo esa relación cambia nuestras vidas de adentro hacia afuera. Este devocional está organizado en 21 días, pero siéntete libre de seguir el ritmo que mejor te funcione. Esta es simplemente una herramienta que te ayudará a encontrar dirección y una plataforma de lanzamiento para iniciar conversaciones sobre lo que estás aprendiendo. Seguir a Jesús es un viaje en el que nunca tendrás que caminar solo. ¡Nos alegra poder hacer esto juntos! <a href='https://rock.gocf.org/Content/Connections/CF_Journey_Print_Handouts_5.5x8.5_YouSaidYes_SPN_FINAL.pdf' download target='_blank'rel='noopener noreferrer'className='text-ocean underline cursor-pointer'>Descárgalo como un PDF</a>.`,
      }
    : {
        title: 'A 21-Day Devotional',
        subtitle: `Inside this devotional, you’ll discover more about what it means to follow Jesus. Each day will include Scriptures to meditate on and ideas to consider as you begin your walk with God. Together, we’ll unpack what it looks like to be in a relationship with Jesus and how that relationship changes our lives from the inside out.<br /> <br /> This devotional spans 21 days, but you can go at your own pace. It’s a tool to guide your journey and spark conversations about your learning. Remember, following Jesus is a journey you don’t have to take alone. We’re excited to share this with you! If you’d like, you can <a href='https://cf.church/freedom-class' target='_blank'>click here</a> to learn more about the Christ Fellowship Freedom Class, which shows us how to forgive ourselves and others. <a href="${ROCK_PUBLIC_SITE_ORIGIN}/Content/website/journey/YouSaidYes_Devotional.pdf" download target="_blank"rel="noopener noreferrer"className="text-ocean underline cursor-pointer">Download it as a PDF</a>.`,
      };
