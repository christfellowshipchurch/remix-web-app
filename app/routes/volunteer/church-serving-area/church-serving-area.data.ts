...
export const STATIC_CHURCH_ROLES: ChurchRole[] = [
  {
    ...
    description: 'Be the first face people see — greet guests and help them find their way.',
    expandedDescription:
  ...
  },
  {
    id: 'usher',
    title: 'Usher',
    description: 'Help people find seats and keep the flow smooth during services.',
    expandedDescription:
  ...
  },
  {
    id: 'host-team',
    title: 'Host Team',
    description: 'Serve coffee, snacks, or welcome stations before and after services.',
    expandedDescription:
