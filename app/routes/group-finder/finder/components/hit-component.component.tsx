...
export function HitComponent({ hit }: { hit: GroupHit }) {
  ...
  return (
    <Link to={`/group-finder/${hit.title}`} className="size-full">
      <div
        className="h-full mb-4 bg-white rounded-lg overflow-hidden w-full max-w-[360px] md:max-w-[300px] lg:max-w-[333px] xl:max-w-[300px] cursor-pointer hover:translate-y-[-2px] transition-all duration-300"
        style={{
          boxShadow:
